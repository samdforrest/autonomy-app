...
export default function CollaborationParentModuleScreen() {
  ...
  const parseWhyHowWhatContent = () => {
      ...
      if (block.content && block.content.length > 0) {
        ...
        block.content.forEach((item: any, itemIndex: number) => {
          if (item.type === 'text' && item.text) {
            ...
            console.log(`🔍 Collaboration analyzing text: "${text}"`);
            ...
            if (whyMatch) {
              console.log('📍 Collaboration Found Why section:', whyMatch[1]);
              parsedBubbles.push({
            ...
            if (howMatch) {
              console.log('📍 Collaboration Found How section:', howMatch[1]);
              parsedBubbles.push({
            ...
            if (whatMatch) {
              console.log('📍 Collaboration Found What section:', whatMatch[1]);
              parsedBubbles.push({
    ...
    console.log('🎯 Collaboration Final parsed bubbles:', parsedBubbles);
  ...
  const renderContent = () => {
    ...
    console.log('🔍 Collaboration Parsed content length:', parsedContent.length);
    console.log('🔍 Collaboration Parsed content:', parsedContent);
