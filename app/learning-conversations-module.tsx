...
export default function LearningConversationsModuleScreen() {
  ...
  const { content, loading, error, refetch } = useGoogleDocsContent(
    ...
    'mistakes',
    { tab: 'Learning Conversations', day: currentDay }
  );
      ...
      return (
        <ThemedView>
          ...
          {content?.contentBlocks && content.contentBlocks.length > 0 ? (
            ...
            Object.entries(content.sections).map(([sectionKey, section]: [string, any]) => (
              <ThemedView key={sectionKey} style={styles.section}>
                <ThemedText style={styles.sectionTitle}>{section.title}</ThemedText>
                {section.content && (
                  <ThemedText style={styles.contentText}>{section.content}</ThemedText>
                )}
              </ThemedView>
            ))
          ) : (
          ...
          <ModuleCompletionTracker
            moduleId="learningconversations"
            moduleName="Learning Conversations"
  ...
  return (
    <ThemedView style={styles.container}>
      <ThemedView style={styles.header}>
        <ThemedText type="title" style={styles.moduleTitle}>Learning Conversations</ThemedText>
        <ThemedText style={styles.moduleSubtitle}>
          I can talk through my learning.
        </ThemedText>
      </ThemedView>
