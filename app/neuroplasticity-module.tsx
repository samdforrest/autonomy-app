...
export default function NeuroplasticityModuleScreen() {
  ...
  const { content, loading, error, refetch } = useGoogleDocsContent(
    ...
    'raw',
    { tab: 'Neuroplasticity', day: currentDay }
  );
  ...
  const dayModules: DayModule[] = [
    {
      id: 'day1',
      title: 'Brain Basics',
      description: 'Understanding how your brain works',
      dayNumber: 1,
      isCompleted: false,
      isLocked: false,
      color: '#FFC93C',
    ...
    },
    {
      ...
      description: 'How brain cells connect and communicate',
      dayNumber: 2,
      isCompleted: false,
      isLocked: false,
      color: '#FF9A3C',
    ...
    },
    {
      ...
      description: 'Believing your brain can grow and change',
      dayNumber: 3,
      isCompleted: false,
      isLocked: false,
      color: '#FF6F3C',
    ...
    },
    {
      ...
      description: 'How practice strengthens neural pathways',
      dayNumber: 4,
      isCompleted: false,
      isLocked: false,
      color: '#155263',
    ...
    },
    {
      id: 'day5',
      title: 'Brain Power',
      description: 'Celebrating your amazing, growing brain',
      dayNumber: 5,
      isCompleted: false,
      isLocked: false,
      color: '#939393',
                ...
                <ThemedView style={styles.dayContent}>
                  ...
                  {!loading && !error && content && (
                    <ThemedView>
                      ...
                      <SurveyButton 
                        moduleId="neuroplasticity"
                        moduleName="Neuroplasticity & Growth"
